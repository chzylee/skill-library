...
|---|---|---|
| **content-starter** | Walks a vague idea to a ready-to-write outline — a *session skill* that loads the **Content strategist** persona (the judgment) and adds the outline scaffolding (the structure). Runs offline on a baked persona snapshot, or live from your Personae Library. | [README](content-starter/README.md) |
